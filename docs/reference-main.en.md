# PC Black Box 0.12.0 technical reference

[Back to the introduction](../README.en.md) / [日本語](reference-main.md)

This page preserves the controls and technical description for main commit `2278b0feeed7aad47a80624b9f7813c4a61c439f`. It is not a specification of the planned StillLens rename or of 0.13.0-preview.1 built from PR #19. Check the [version mapping](../README.en.md#source-and-preview-are-different-versions).
...
The current script starts the application without command-line arguments. Do not run it when GUI startup is prohibited; record the boundary gate as not run. `-WindowStyle Hidden` is not a guarantee of headless operation.
